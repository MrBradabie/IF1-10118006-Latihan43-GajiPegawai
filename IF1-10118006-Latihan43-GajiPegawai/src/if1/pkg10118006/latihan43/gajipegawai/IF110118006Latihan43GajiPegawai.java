 ...
 */
package if1.pkg10118006.latihan43.gajipegawai;
 ...
 */
public class IF110118006Latihan43GajiPegawai {
    ...
    public static void main(String[] args) {
        ...
        karyawan1.setNama("Alfarizi Rizki Pane");
        karyawan1.setAlamat("Jalan Dago Barat No. 11f");
